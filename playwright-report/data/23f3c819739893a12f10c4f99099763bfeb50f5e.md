...
- Name: presentations.spec.js >> My Presentations page >> generate button enables when text is typed
- Location: tests/presentations.spec.js:86:7
...
> 15  |   await expect(page.getByRole('button', { name: 'Book Recommender' })).toBeVisible({ timeout: 15_000 })
  ...
  107 |     await expect(page.locator('select').nth(1)).toBeVisible()
  108 |   })
  109 | 
