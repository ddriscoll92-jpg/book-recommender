...
Locator: getByText('Current password')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Current password')
...
- button "×"
- text: 👤 Personal 🏫 School ⚙️ Preferences 🔑 Password 🗑️ Account
- paragraph: Choose a strong password of at least 6 characters.
- text: New password
