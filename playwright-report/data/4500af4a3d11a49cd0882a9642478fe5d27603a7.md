...
- Name: home.spec.js >> Home screen (pre-login) >> nav How it works link scrolls to section
- Location: tests/home.spec.js:29:7

# Error details

```
Error: locator.click: Error: strict mode violation: getByText('How it works') resolved to 2 elements:
    1) <span>How it works</span> aka locator('span').filter({ hasText: 'How it works' })
    2) <h2>How it works</h2> aka getByRole('heading', { name: 'How it works' })
