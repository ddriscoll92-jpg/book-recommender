...
- Name: profile.spec.js >> Profile & settings >> School tab shows year groups field
- Location: tests/profile.spec.js:81:7
...
Locator: getByText('Year groups you teach')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Year groups you teach')
...
- button "×"
- text: 👤 Personal 🏫 School ⚙️ Preferences 🔑 Password 🗑️ Account School name
- textbox "e.g. St Mary's Primary School"
- text: Region
- combobox:
...
- text: Year groups I teach Year 1 Year 2 Year 3 Year 4 Year 5 Year 6
- button "Save school details"
```
