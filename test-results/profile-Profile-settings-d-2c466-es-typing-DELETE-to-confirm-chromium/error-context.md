...
- Name: profile.spec.js >> Profile & settings >> delete requires typing DELETE to confirm
- Location: tests/profile.spec.js:135:7
...
Locator: getByPlaceholder(/Type DELETE/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByPlaceholder(/Type DELETE/i)
...
- button "×"
- text: 👤 Personal 🏫 School ⚙️ Preferences 🔑 Password 🗑️ Account ⚠️ Delete account
- paragraph: This will permanently delete your account, all your plans, resources and library books. This cannot be undone.
- text: Type
- strong: DELETE
- text: "to confirm:"
- textbox "DELETE"
- button "Confirm deletion" [disabled]
- button "Cancel"
```
