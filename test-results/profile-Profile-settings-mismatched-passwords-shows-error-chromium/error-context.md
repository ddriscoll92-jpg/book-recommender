...
- Name: profile.spec.js >> Profile & settings >> mismatched passwords shows error
- Location: tests/profile.spec.js:115:7
...
Call log:
  - waiting for locator('input[type="password"]').nth(2)
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e76]:
        ...
        - generic [ref=e81]:
          ...
          - textbox "Confirm password" [active] [ref=e83]: newpassword123
          - generic [ref=e84]: Passwords do not match
        - button "Update password" [ref=e85] [cursor=pointer]
        - generic [ref=e86]:
          - generic [ref=e87]: Forgotten your password?
          - button "Send reset email" [ref=e88] [cursor=pointer]
```
