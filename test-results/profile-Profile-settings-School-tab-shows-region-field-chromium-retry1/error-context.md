...
- Name: profile.spec.js >> Profile & settings >> School tab shows region field
- Location: tests/profile.spec.js:76:7
...
Locator: getByText('Region')
Expected: visible
Error: strict mode violation: getByText('Region') resolved to 2 elements:
    1) <label>Region</label> aka getByText('Region', { exact: true })
    2) <option value="">Select region...</option> aka getByRole('combobox').nth(2)

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Region')
...
- generic [ref=e3]:
  ...
  - generic [ref=e64]:
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e76]:
        - generic [ref=e77]:
          - generic [ref=e78]: School name
          - textbox "e.g. St Mary's Primary School" [ref=e79]
        - generic [ref=e80]:
          - generic [ref=e81]: Region
        ...
        - generic [ref=e83]:
          - generic [ref=e84]: Year groups I teach
          - generic [ref=e85]:
            - generic [ref=e86] [cursor=pointer]: Year 1
            - generic [ref=e87] [cursor=pointer]: Year 2
            - generic [ref=e88] [cursor=pointer]: Year 3
            - generic [ref=e89] [cursor=pointer]: Year 4
            - generic [ref=e90] [cursor=pointer]: Year 5
            - generic [ref=e91] [cursor=pointer]: Year 6
        - button "Save school details" [ref=e92] [cursor=pointer]
```
